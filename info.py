...
auth_channel = environ.get('AUTH_CHANNEL', '-5070088348') # give your force subscribe channel id here else leave it blank
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MAGUCxBots') # Support Chat Link Without https:// or @
