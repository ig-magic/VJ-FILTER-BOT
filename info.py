...
PICS = (environ.get('PICS', 'https://i.ibb.co/GNwqmK7/Movies.png')).split()
...
auth_channel = environ.get('AUTH_CHANNEL', '-1003143645401') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003407691241')).split()]  # For Multiple Id Use One Space Between Each.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+5FRviZsRHrs4NTc1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MAGICxBots')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'moviesrqu') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/ig_magic')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'c2a118fca4bc5b859e08f6bc52667a860316fbcb')
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'c2a118fca4bc5b859e08f6bc52667a860316fbcb')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/moviesrqu/107') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://vj-filter-bot-0fqx.onrender.com/")
